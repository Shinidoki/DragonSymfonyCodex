...
final class Version20260124140000 extends AbstractMigration
{
    ...
    {
        // Defensive: during local development it's easy to end up with an existing schema but an empty migrations table.
        if (!$schema->hasTable('game_character_goal')) {
        ...
        if (!$schema->hasTable('game_character_event')) {
            $this->addSql('CREATE TABLE game_character_event (id int AUTO_INCREMENT NOT NULL, world_id int NOT NULL, character_id int DEFAULT NULL, type varchar(128) NOT NULL, day int NOT NULL, created_at DATETIME NOT NULL, data json DEFAULT NULL, INDEX idx_character_event_world_day (world_id, DAY), INDEX idx_character_event_world_type_day (world_id, TYPE, DAY), INDEX idx_character_event_character_day (character_id, DAY), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');

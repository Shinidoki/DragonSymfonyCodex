...
use App\Game\Domain\Goal\Handlers\ChallengeDojoMasterGoalHandler;
use App\Game\Domain\Map\TileCoord;
use App\Game\Domain\Npc\DailyActivity;
use App\Game\Domain\Race;
use PHPUnit\Framework\TestCase;

final class ChallengeDojoMasterGoalHandlerTest extends TestCase
{
    public function testTravelsToNearestDojoThenEmitsChallengeRequest(): void
    {
        ...
        $handler = new ChallengeDojoMasterGoalHandler();
